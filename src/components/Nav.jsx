        ...
        <div className="flex sm:gap-5 gap-2 items-center bg-transparent">
            <div className="relative flex justify-end sm:block">
                ...
                <input
                    ...
                    className={`bg-[#141414] border-[0px] overflow-hidden rounded-sm text-white focus-within:outline-none ${isSearching ? "sm:px-9 px-6 py-1 sm:w-full w-[70%] sm:text-[17px] text-[12px] border-[1px] transition-[padding-left] sm:transition-[padding-right,padding-left] duration-500" : "w-0 px-0 py-0 "}`}
